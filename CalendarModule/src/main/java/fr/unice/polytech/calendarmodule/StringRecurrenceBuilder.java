 ...
 */
public class StringRecurrenceBuilder {
    /**
     * CONSTANTES
     */
    //Type
...
public static String gcanlendarToString(GregorianCalendar g){
     ...
     * CONSTRUTOR
     */
    public StringRecurrenceBuilder(){
        rruleArgs = new HashMap<String,String>();
    }

    public StringRecurrenceBuilder freqByDay(){
        rruleArgs.put(FREQUENCE,DAILY);return this;
    }
    public StringRecurrenceBuilder freqByWeek(){
        rruleArgs.put(FREQUENCE,WEEKLY);return this;
    }
    public StringRecurrenceBuilder freqByYear(){
        rruleArgs.put(FREQUENCE,YEARLY);return this;
    }
    public StringRecurrenceBuilder freqByMonth(){
        rruleArgs.put(FREQUENCE,MONTHLY);return this;
    }
    public StringRecurrenceBuilder freqByMinute(){
        rruleArgs.put(FREQUENCE,MINUTELY);return this;
    }
    public StringRecurrenceBuilder freqByHour(){
    ...
    public StringRecurrenceBuilder interval(int gap){
        rruleArgs.put(INTERVAL,gap+"");return this;
    }

    public StringRecurrenceBuilder byDay(int day) throws IndexDayOutOfBoundException {
    ...
    public StringRecurrenceBuilder byMonth(int month) throws IndexMonthOutOfBoundException {
    ...
    public StringRecurrenceBuilder byMonthDay(int dayNumber){
    ...
    public StringRecurrenceBuilder byYearDay(int dayNumber){
    ...
    public StringRecurrenceBuilder byWeekNumber(int weekNumber){
    ...
    public StringRecurrenceBuilder weekStart(int day) throws IndexDayOutOfBoundException {
        if(day<0 || day>6)throw new IndexDayOutOfBoundException(day);
